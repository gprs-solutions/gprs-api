...
class CertController
{
    ...
    /**
     * CertService instance
     *
     * @var CertService $service
     */
     ...
     * Constructor method.
     *
     * @param CertService $service The certification service.
     *
     * @return void
     */
    public function __construct(CertService $service)
    {
        $this->service = $service;
    }

    /**
     * Validates if a request to get an certification is valid.
     *
     * @param Request $request Request with the certification info.
     *
     * @return JsonResponse
     */
    ...
    /**
     * Validates if a request to create an certification is valid.
     *
     * @param Request $request Request with the certification info.
     *
     * @return JsonResponse
    ...
    /**
     * Validates if a request to update an certification is valid.
     *
     * @param Request $request Request with the certification info.
     *
     * @return JsonResponse
    ...
    /**
     * Validates if a request to suspend an certification is valid.
     *
     * @param Request $request Request with the certification info.
     *
     * @return JsonResponse
