...
{
    /**
     * ExperienceModel instance
     *
     * @var Experience $service
     */
     ...
     * Constructor Method.
     *
     * @param Experience $model ExperienceModel instance.
     *
     * @return void
     */
    ...
    public function get(
        ...
        return ServiceResult::success(data: new ExperienceResource($exp));
    }
